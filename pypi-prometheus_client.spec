...
Source0  : https://files.pythonhosted.org/packages/5b/5a/3fa1fa7e91a203759aaf316be394f70f2ef598d589b9785a8611b6094c00/prometheus_client-0.22.0.tar.gz
...
%prep
%setup -q -n prometheus_client-0.22.0
cd %{_builddir}/prometheus_client-0.22.0
pushd ..
cp -a prometheus_client-0.22.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747670743
