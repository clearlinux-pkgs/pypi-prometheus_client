...
Source0  : https://files.pythonhosted.org/packages/e1/54/a369868ed7a7f1ea5163030f4fc07d85d22d7a1d270560dab675188fb612/prometheus_client-0.21.0.tar.gz
...
%prep
%setup -q -n prometheus_client-0.21.0
cd %{_builddir}/prometheus_client-0.21.0
pushd ..
cp -a prometheus_client-0.21.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726851476
