...
Source0  : https://files.pythonhosted.org/packages/62/14/7d0f567991f3a9af8d1cd4f619040c93b68f09a02b6d0b6ab1b2d1ded5fe/prometheus_client-0.21.1.tar.gz
...
%prep
%setup -q -n prometheus_client-0.21.1
cd %{_builddir}/prometheus_client-0.21.1
pushd ..
cp -a prometheus_client-0.21.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733324924
