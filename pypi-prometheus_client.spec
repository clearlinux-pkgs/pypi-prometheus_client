...
Source0  : https://files.pythonhosted.org/packages/5e/cf/40dde0a2be27cc1eb41e333d1a674a74ce8b8b0457269cc640fd42b07cf7/prometheus_client-0.22.1.tar.gz
...
%prep
%setup -q -n prometheus_client-0.22.1
cd %{_builddir}/prometheus_client-0.22.1
pushd ..
cp -a prometheus_client-0.22.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748898290
