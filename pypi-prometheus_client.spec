...
Source0  : https://files.pythonhosted.org/packages/35/d2/b7dc2f5d91ccfe1c64917874dc3db94b8866d0e631a55cd864ad12b275fb/prometheus_client-0.18.0.tar.gz
...
%prep
%setup -q -n prometheus_client-0.18.0
cd %{_builddir}/prometheus_client-0.18.0
pushd ..
cp -a prometheus_client-0.18.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698700145
